...
(8, '98:7B:F3:75:18:0C', 'Bean-SG11116', '0000-00-00 00:00:00', '2016-04-26 03:09:19'),
(9, '88:C2:55:AC:26:AE', 'Bean-SG11111', '0000-00-00 00:00:00', '2016-04-26 03:09:19');
...
CREATE TABLE IF NOT EXISTS `rental` (
  ...
  `pickup_station_id` int(11) unsigned DEFAULT NULL,
...
INSERT INTO `rental` (`id`, `booking_id`, `user_id`, `bicycle_id`, `serial`, `book_at`, `return_at`, `duration`, `created_at`, `updated_at`, `pickup_at`, `return_station_id`, `pickup_station_id`) VALUES
(1, 'A1234B1111C', 1, 1, 'RENT111', '2016-08-01 15:00:00', '2016-08-01 16:30:00', 90, 1461214049, 1461926225,'2016-08-01 15:05:00',5,5),
(2, 'A1234B2222C', 2, 2, 'RENT112', '2016-08-01 14:00:00', '2016-08-01 14:30:00', 30, 1461214049, 1461926225,'2016-08-01 14:05:00',5,5),
(3, 'A1234B3333C', 3, 3, 'RENT113', '2016-08-01 12:00:00', '2016-08-01 13:00:00', 60, 1461214049, 1461926225,'2016-08-01 12:05:00',5,5),
(4, 'A1234B4444C', 1, 4, 'RENT114', '2016-08-02 10:00:00', '2016-08-01 10:30:00', 30, 1461214049, 1461926225,'2016-08-02 10:05:00',5,5),
(5, 'A1234B5555C', 2, 5, 'RENT115', '2016-08-02 14:00:00', '2016-08-01 14:30:00', 30, 1461214049, 1461926225,'2016-08-02 14:05:00',5,5);
